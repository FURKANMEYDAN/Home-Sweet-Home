    ...
    public class EşyaRepository
    {
        ...
        static EşyaRepository()
        {
            _Eşyalar = new List<Eşyalar>(){
                ...
                new Eşyalar(){Id=24,Ad="amorf coffe table",Image=" //lazzoni.com/cdn/shop/products/amorf-coffetable-1_360x.jpg?v=1634024770"},
                ...
                new Eşyalar(){Id=31,Ad="hexa ayna",Image=" //lazzoni.com/cdn/shop/files/hexa-ayna-1_540x.jpg?v=1691486876 "},
